                ...
                <div id="container" class="clear">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nome" id="exampleFormControlInput1" placeholder="Hard Sun">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="duracao" class="form-control" id="exampleFormControlInput1" placeholder="14:23">
                    </div>
